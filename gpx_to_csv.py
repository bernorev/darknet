...
class Converter(object):
    ...
    def _gpx_to_dict(self,time_colname="time", lats_colname="latitude", longs_colname="longitude"):
        time,longs, lats = [], [], []
        ...
        return {time_colname: time, lats_colname: lats, longs_colname: longs}
    ...
    def gpx_to_dataframe(self,time_colname="time", lats_colname="latitude", longs_colname="longitude"):
        """
    ...
    def gpx_to_csv(self,time_colname="time", lats_colname="latitude", longs_colname="longitude", output_file=None):
        """
