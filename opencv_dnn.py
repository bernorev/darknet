...
inpHeight = 1440      #Height of network's input image
...
classesFile = "./data/fruit.names"
classes = None
with open(classesFile, 'rt') as f:
    classes = f.read().rstrip('\n').split('\n')

# Give the configuration and weight files for the model and load the network using them.
modelConfiguration = "./cfg/yolov4-tiny_fruit.cfg"
modelWeights = "./backup/yolov4-tiny_fruit_last.weights"
...
while cv2.waitKey(1) < 0:
    ...
    frame = cv2.resize(frame,(inpWidth, inpHeight),interpolation=cv2.INTER_LINEAR)
